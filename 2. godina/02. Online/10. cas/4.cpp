// 4. Za zadati string, pronaci broj ponavljanja samoglasnika (A, E, I, O, U)
...
int main(){
	string poruka = "Ovo je string, kome treba prebrojati broj ponavljanja samoglasnika.";
	cout << "Zadata recenica:" << endl << poruka << endl;
	...
	cout << "\tO: " << o << endl;
	cout << "\tU: " << u << endl;
	cout << "Ukupan broj je: " << a+e+i+o+u << endl;
